...
const JobCard = (props: Props) => {
  ...
  return (
    <div className="flex flex-col cursor-pointer items-start gap-3.5 p-[24px]  w-full bg-[#FEFEFF] rounded-[8px] ">
      ...
      <div className="flex flex-col gap-[1px]">
        <div className="flex  items-center gap-[13px]">
          ...
          <div className="flex gap-1 items-center text-[10px] text-[#68696F]"></div>
        </div>
